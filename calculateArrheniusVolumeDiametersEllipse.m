...
function [all_liver_volumes,all_liver_diameters,all_liver_diameters2] = calculateArrheniusVolumeDiametersEllipse(file_path,splitInHalf,splitInHalfx)
...
for patient_selection = 1:1
   ...
   baseline_data = readtable(file_path);
    ...
    BoundaryPoints.all = zeros(2000, 20*4*3);
