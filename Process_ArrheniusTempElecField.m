...
function [export] = FCcalculateArrhVolDiamEllipBound(file_path, arrhenius_thresh )
...
for i = 1: numTimePoints
    ...
    numentries = length(arrhenius(indices));
    pointsWithArrheniusAbove98( 1:numentries, a:b ) = ...
         [coords(indices, :), arrhenius(indices), electricField(indices)] ;
