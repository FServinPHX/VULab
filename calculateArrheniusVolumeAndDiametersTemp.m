...
function [all_liver_volumes,all_liver_diameters] = calculateArrheniusVolumeAndDiametersTemp(file_path)
[filepath,name,ext] = fileparts(file_path);    
%
%%%SECTION OF CODE that prepares the data that has temperature and arrhenius
%%%data 
...
%                 %%REMOVES all points where there is no tissue necrosis
    ...
    %%%SECTION OF THE CODE THAT Exporting Data as CSV
