...
close all
    ...
    directoryPath =  'D:\Import To Matlab\0.0 COMSOL to Synthetic ptCloud'
    ...
    %
    exportDIR = 'D:\Import To Matlab\0.0 COMSOL to Synthetic ptCloud\Regular Grid';
...
%
for fi = 93 :   size(  FilesCSV, 1)   %  size(  FilesCSV, 1)
    tic
% figure() 
