...
switch selected_data_dir
    case 1
      selected_dir = 'D:\ML COMSOL Models\COMSOL LowFat\Ablation Grid'
      dir_name_str = 'Low Fat';
    case 2
     selected_dir =   'D:\ML COMSOL Models\COMSOL MildFat\Ablation Grid'
     dir_name_str = 'Mild Fat';
    case 3
      selected_dir = 'D:\ML COMSOL Models\COMSOL ModerateFat\Ablation Grid'
      dir_name_str = 'Moderate Fat';
    case 4
      selected_dir = 'D:\ML COMSOL Models\COMSOL ZHighFat\Ablation Grid'
      dir_name_str = 'High Fat';

end 

% Specify the directory you want to search in
%GroundTruthDir = 'D:\Import To Matlab\COMSOL Pointcloud ML_ALL Data   Binary Mask _ Distances  __ptIV'
GroundTruthDir =selected_dir
...
%
ExportDir = selected_dir
%
%
%SyntheticDataDir = 'D:\Import To Matlab\0.0 COMSOL to Synthetic ptCloud\Regular Grid'
SyntheticDataDir = 'D:\ML COMSOL Models\COMSOL LowFat\Ablation Grid'
% Create a pattern to match .mph files
...
filenameMod = join([ 'Zz Ablation Grid',  dir_name_str,'Vs Low Fat']);
% VideoName = "0A_Synthetic_Vs_GroundTruth Volume_pct_Diff RUNS-  5";
% ypred_fname = "0A_Synthetic_Vs_GroundTruth";
VideoName = join([ filenameMod , "Volume_pct_Diff RUNS-  9"]);
...
%for mltbI = 1:1
        if iCreateVideo == "TRUE"
            if count ==  1
                Video_Dir = "D:\ML COMSOL Models\VIdeos";
    ...
    figure(1)
        ...
        subplot(1,3,3)
           ...
           hold on
            ...
            scatter3( P(:,1) , P(:,2) ,P(:,3), 11,  fltrd__intnsty__C, 'filled',  'MarkerFaceAlpha', 0.75) 
                cb=colorbar;
                cb.FontSize = 18;
                title(cb, join(["SDA_{T-A}", newline, "(mm)"]) );
                    currentPosition = cb.Position;
        ...
        if SavePlot == "TRUE"
            SavePlotDir = 'D:\VideoFiles\VISEsymp2024\Synthetic';
...
[angleDegrees, angleRadians, avgDistance] = Aim3_fn_analyze3DLines( plotedLine1, plotedLine2 );
Volume_Store = [Volume_Store;  angleDegrees, angleRadians, avgDistance, Volume, Volume2];
...
Variable_Names = [ "angleDegrees", "angleRadians", "avgDistance", "Volume", "Volume2"]
Volume_Store_all = [Volume_Store_all,  [Variable_Names; Volume_Store] ]; 
    ...
    if export_DIR == "TRUE"
        ...
        switch exportcase
            ...
            case 1
                ...
                exportDir = 'D:\ML COMSOL Models\VIdeos\';
            ...
            case 2
                %adjust = [.1, ones(1, 13) ] ; 
                Volume_Store_all = Volume_Store_all ;%.* adjust';
                exportDir = ExportDir; 
                csvExportName = join([exportDir, ypred_fname, "Volume_All_Information",...
                                      "RUNS-", num2str(All_Unique_Runs), ".csv"]);
                writematrix(  Volume_Store_all,  csvExportName);
                disp("Data Exported")
                disp( csvExportName )
        end 
