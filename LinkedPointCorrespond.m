...
sorted_min_values = sort(dist_matrix, 'descend');
% Select the highest 1000 minimum values
highest_min_values = sorted_min_values(1:1300);
% Calculate the mean, median, and standard deviation of the highest 1000 minimum values
mean_high_min = mean(highest_min_values);
median_high_min = median(highest_min_values);
std_high_min = std(highest_min_values);


min_dist = 0; 
max_dist = mean_high_min;
