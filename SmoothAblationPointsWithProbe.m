...
function   [SmoothedAblationPoints, ExportProbePoints] = SmoothAblationPointsWithProbe( ProbeFilePath, MphName, timePoints, startPoint, numTimePoints)   
...
SmoothedAblationPoints = cell(numTimePoints, 1) ; 
ExportProbePoints = cell(numTimePoints, 1) ; 
%
input_str = MphName;
...
%
%
disp( join(['The FOUND experiment number is: ' , num2str( experiment_num_Ant_All(indices) ) ]) )
