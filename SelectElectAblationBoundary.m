...
% %D:\Import To Matlab\
function [fileName ] = SelectElectAblationBoundary(  type, PatientNum )
...
case "EField"
    ...
    dirName = "D:\Import To Matlab\Box Phantom\MultiprobeRefined\T_ThetaD_Electric Field\Elec_Correlation\" ;   
    Files= ["All ArrPoints BoxGeomPhantomMultiprobe_TrueBeef0Degrees_UN_Refined_4.95mmSpace.csv";
            "All ArrPoints BoxPhantomMultiprobe_TrueBeef0Degrees_Refined_9.9mmSpc.csv";
            "All ArrPoints BoxGeomPhantomMultiprobe_TrueBeef0Degrees_UN_Refined_14.95mmSpace.csv" ;
            "All ArrPoints BoxGeomPhantomMultiprobe_TrueBeef0Degrees_UN_Refined_19.8mmSpace.csv" ;
    ...
    dirName = "D:\Import To Matlab\Box Phantom\MultiprobeRefined\T_ThetaD_Electric Field\Elec_Correlation\" ;   
    Files= ["All ArrPoints BoxGeomPhantomMultiprobe_TrueBeef0Degrees_Refined_SingleAblation.csv";];   
...
fileName = fullfile( [ convertStringsToChars(dirName), convertStringsToChars(Files(PatientNum)) ]) ;
