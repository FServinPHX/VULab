...
function [ProbePointExport, plotedLine1, plotedLine2] =  A3_FindPlotPoints_CustomPlacements(file_path, ProbePlacementInformation)
    ...
    ProbeFilePath = ProbePlacementInformation;
