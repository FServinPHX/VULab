...
fileName = "C:\Users\servinf\Documents\1.0 Vanderbilt\Dr. Miga Lab\Liver Project - Ablation - 2021\COMSOL_DATA\Box Phantom Ablation\Multiprobe\Results\ALLVolumeA98Multiprobe.csv";
...
black = [0	0	0];
colors = [green; blue; orange; gold; purple; black];

%legend_base = ["No Fat", "Low Fat", "Mild Fat","Moderate Fat", "High Fat"];
legendBase = [ "0", "5","10", "15", "20", "25"];
set(gcf,'color','w');
legendString = [];
...
%         end 
    ...
    xlabel("Time (min)")
    title("Ablation Trajectory in Multiprobe Models")
