function [returnData, BndPtsin , BndPtsout, Expt, STumor ] =...
    ObjectIntersectionTri(TumorPointsOG  ,...
    BoundaryPointsOG,  itime, ColorAbl, ColorTum  ) 
...
p1 = plot( STumor.complete   ,'FaceColor', ColorTum  ,'FaceAlpha', 0.6 ,...
...
returnData = [ Vol1,  Vol3,  Vol2, Vol4] ;
axis off
grid off
