...
%       D:\ML COMSOL Models\COMSOL LowFat\Ablation Grid
%       D:\ML COMSOL Models\COMSOL MildFat\Ablation Grid 
%       D:\ML COMSOL Models\COMSOL ModerateFat\Ablation Grid
%       D:\ML COMSOL Models\COMSOL ZHighFat\Ablation Grid

% Specify the directory you want to search in
GroundTruthDir = 'D:\Import To Matlab\COMSOL Pointcloud ML_ALL Data   Binary Mask _ Distances  __ptIV\0 Degree'
% GroundTruthDir ='D:\ML COMSOL Models\COMSOL ZHighFat\Ablation Grid 970'
...
VideoName = "0_FinalRun_Synthetic_Vs_GroundTruth Volume_pct_Diff RUNS-  ";
ypred_fname = "0_FinalRun_Synthetic_Vs_GroundTruth";
% filenameMod = 'Zz Ablation Grid High Fat 970 Vs Low Fat'
...
set(groot, 'DefaultAxesFontWeight', 'normal', 'DefaultTextFontWeight', 'normal');
    ...
    if export_DIR == "TRUE"
        ...
        exportDir = 'D:\Import To Matlab\01. Machine Learning Models Data\predict\';
        csvExportName = join([exportDir, ypred_fname, "FinalMachineLearningModel___Volume_pct_Diff",...
                              "RUNS-", num2str(All_Unique_Runs), ".csv"]);
